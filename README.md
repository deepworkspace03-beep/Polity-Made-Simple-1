...
A clean, fast, dark-mode-first website for a UGC NET Political Science
...
├── pages/               # Home, Paper1, Paper2, MockTests
└── components/          # Header, Hero, browser, About, Contact, footer, etc.
```
...
- Dark mode is the default; the header toggle switches the whole site and
  remembers your choice.
- The filter pills are UI-only for now (they highlight but don't filter yet).
